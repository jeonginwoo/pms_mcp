...
/**
 * FR-AI-14 · FR-AI-17 — search_maintenance는 2026-08-11 결정 ④(id 확보 경로 공백 해소,
 * 카탈로그 7종→8종).
 *
 * TODO(M1 EPIC D): maintenance 모듈 자체가 아직 없다(계약/사이트/이슈 3층 + 시드 적재).
 * 도메인이 서기 전에도 도구를 노출해 두는 것이 카탈로그의 계약이다 — 이 두 도구는
 * 유지보수 질문의 유일한 입구이므로, 빠지면 모델이 프로젝트 조회로 잘못 우회한다.
 */
@Component
