...
- [x] 시드 데이터 적재 (`reference/seed/`) — **identity분 2026-08-18 완료**(pms 트랙: `IdentitySeedLoader` — 인력 44+시스템 계정·조직 트리 18노드·직급 9·기본 그룹 4종·User 45, 기동 시 빈 DB 자동 적재·멱등·시드 id 정합 보증). projects·maintenance 시드는 해당 도메인 구현 시(PMS-M2·M4) 각 모듈이 적재
