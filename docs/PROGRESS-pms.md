...
- **다음 작업:** **ROADMAP M1 pms 절 ②** 감사 조회 2뷰(G1-3·G2-2 — 권한·가시성 판정은 이미 실구현, 최신순 파생 질의만). ①(계약 2종)·③(projects 시드 382건)은 2026-08-23 완료. ④EPIC C 가동률은 ①의 MCP 확인 후. **G1 전 필수 선행 1건 등재**: 인물 이름 재매핑 194곳(eval 채점이 이름 대조를 포함 — PRD-pms §12)
